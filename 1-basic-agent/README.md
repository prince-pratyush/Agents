...
This example demonstrates a simple greeting agent that asks for the user's name and greets them personally, showing the fundamentals of agent creation with ADK.
